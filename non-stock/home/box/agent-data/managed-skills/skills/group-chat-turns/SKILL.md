...
- Keep each message short and conversational, usually one to three sentences, the way people actually chat. Send at most 3 messages in one room turn. Do not monologue or summarize the whole thread.
